        ...
        <div className="w-80 h-76 bg-[rgb(24,27,32)] border border-[rgb(84,90,106)] rounded-[20px] text-white flex flex-col p-5 overflow-hidden transition-colors duration-300 group-hover:bg-gray-800">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col flex-1">
              <div className="text-[20px] text-center leading-[22px] font-semibold pe-7 mt-2">
                {post.title}
              </div>
            </div>
          </div>

          {/* Image Banner - MODIFICATO */}
          <div className="mt-2 flex-1 flex items-center justify-center overflow-hidden">
            <img
              src={post.image_url}
              alt={post.title}
              className="w-full h-auto max-h-[150px] rounded-[20px] object-cover"
            />
          </div>
