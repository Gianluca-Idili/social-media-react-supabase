...
export const SkullIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M20 12c0 8-8 8-8 8s-8-8-8-8 8-8 8-8 8 8 8 8zm-8.5-3.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm-3 5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"
    />
  </svg>
);
...
export const WorkIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
//non svg ma va bene cosi hahahaha
...
export const GradientCheckIcon = () => (
  ...
  >
    ...
    <defs>
      <linearGradient id="gradientCheck" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    <rect
      width="40"
      height="20"
      rx="10" /* rounded-full equivalente */
      fill="url(#gradientCheck)"
    />
    
    {/* Simbolo di check (✓) nero */}
    <text
      x="20"
      y="14"
      fill="#000"
